...
public:
    ...
    virtual std::vector<bool> StateValidateBatch(std::vector<StateVarsType>& state_vars_vec, int thread_id=0){};
    virtual std::vector<StateVarsType> GetExplicitGraph(const StateVarsType& root_state_vars){};
