...
public:
    ...
    virtual ActionSuccessor GetSuccessorLazy(const StateVarsType& state_vars, int thread_id=0)=0; 
    virtual ActionSuccessor GetSuccessorProxy(const StateVarsType& state_vars, int thread_id=0)=0; 
