...
//
//     batch_process_ = shared_ptr<thread>(new thread(&BatchPlanner::batchProcess, this));
//     // monitor_paths_process_ = shared_ptr<thread>(new thread(&BatchPlanner::monitorPaths, this));    
//     planner_stats_.num_threads_spawned = 2;
//
//     int plan_idx = 0;
...
// bool BatchPlanner::replanBPLP()
// {
//     if (VERBOSE) cout << "------------ Replanning BPLP ------------" << endl;
//
...
// void BatchPlanner::delegateEdges()
// {
//     while (!terminate_)
//     {
...
//                     edge_evaluation_futures_.emplace_back(async(launch::async, &BatchPlanner::evaluateEdgeLoop, this, thread_id));
...
// void BatchPlanner::evaluateEdge(EdgePtrType edge_ptr, int thread_id)
// {
//     lock_.lock();
...
// }
//
// void BatchPlanner::evaluateEdgeLoop(int thread_id)
// {
//     while (!terminate_)
//     {
//
...
// void BatchPlanner::monitorPaths()
// {
//     while (!terminate_)
//     {
//         lock_2_.lock();
...
// void BatchPlanner::assignEdgePriority(EdgePtrType& edge_ptr)
// {
//     edge_ptr->evaluation_priority_ = 1;
// }
//
// void BatchPlanner::updateEdgePriority(vector<EdgePtrType>& edge_ptrs, double factor)
// {
...
// }
//
// void BatchPlanner::updateEdgePriority(EdgePtrType& edge_ptr, double factor)
// {
