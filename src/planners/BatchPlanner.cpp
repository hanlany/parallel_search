...
void BatchPlanner::selectBatch()
{
    // One problem rn is that we have an implicit graph. How do we cheaply create and select states to form a batch?
    // Sampling?
    // LazygetSuccess?
}
...
void BatchPlanner::updateState(StatePtrType& state_ptr, ActionPtrType& action_ptr, ActionSuccessor& action_successor)
{
